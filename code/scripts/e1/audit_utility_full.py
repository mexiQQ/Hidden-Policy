...
def publish(db, output=OUTPUT, report_path=REPORT):
    ...
    lines += ["", "## 续接", "", "```sh",
              "python3 code/scripts/e1/audit_utility_full.py status",
              "python3 code/scripts/e1/audit_utility_full.py claim --owner utility-worker --limit 40",
              "python3 code/scripts/e1/audit_utility_full.py complete --owner utility-worker --decisions LOCAL_DECISIONS.json",
              "python3 code/scripts/e1/audit_utility_full.py publish", "```", "",
